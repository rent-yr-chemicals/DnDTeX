...
% Insert path to a blank D&D 5E character sheet here, suggested path is ./resources/background.pdf, but
% the actual filename/path can be anything, just update this line accordingly. I'm not including the character
